function [CL,CL_n,S_pn,S_pn1,DIST,Mark]=clsr(CL,f,flag,DIS,h,dim,S_pn,DIST,g,q,omega,Mark,list,thr)   
...
% %                             [mrg]=test_Mabi_Outlier(ind(i),ms,DIS,omega);
                                [mrg,DIST,Mark]=test(ind(i),ms,DIS,CL{1,ms},CL{1,ind(i)},omega,DIST,Mark,list,thr,dim);
%                                
                            if mrg
                                if  L(ms)==0
